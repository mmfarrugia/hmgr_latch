#!/users/mfarrugi/.conda/envs/HMGR/bin/python
...
def extract_structures( struct_db, rename_function = None ):
    args = [
        os.path.expanduser( '/opt/crc/r/rosetta/2021.38/rosetta.source.release-296/main/source/bin/score_jd2.default.linuxgccrelease' ),
